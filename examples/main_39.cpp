...
typedef safe_ptr<field_t, spinlock_t> safe_ptr_field_t;


contfree_safe_ptr< std::map<int, safe_ptr_field_t> > safe_map_contfree_rowlock_global;
...
int main() {
    ...
    const size_t iterations_count = 1000;     // operation of data exchange between threads
